...
public abstract class CacheMetadata extends JsonBaseModel {
   ...
   * Used with {@link com.google.adk.agents.ContextCacheConfig} to trigger automatic cache refresh.
   *
  ...
  public String toString() {
    ...
    if (expireTime().isEmpty()) {
      return String.format("Cache %s: %d contents, expiry unknown", cacheId, contentsCount());
    }

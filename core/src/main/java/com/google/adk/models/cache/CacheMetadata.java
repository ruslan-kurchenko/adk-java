...
public abstract class CacheMetadata extends JsonBaseModel {
   ...
   *
   * <p>Incremented for each invocation that reuses the cache. When this reaches {@code
   * ContextCacheConfig.cacheIntervals()}, the cache is recreated.
   *
   * <p>Null when no active cache exists.
   *
   * @return The invocation count, or empty if no active cache
   */
  ...
  public abstract static class Builder {
    ...
    /**
     * Sets the invocation usage count.
     *
     * @param count Number of times cache has been used, or null
     * @return This builder
     */
    @JsonProperty("invocations_used")
    @CanIgnoreReturnValue
    public abstract Builder invocationsUsed(@Nullable Integer count);

    /**
     * Sets the invocation usage count using Optional.
     *
     * @param count Optional invocation count
     * @return This builder
     */
    @CanIgnoreReturnValue
    public abstract Builder invocationsUsed(Optional<Integer> count);
  ...
  public String toString() {
    ...
    return String.format(
        ...
        cacheId, invocationsUsed().orElse(0), contentsCount(), timeUntilExpiryMinutes);
  }
}

...
public class CachePerformanceAnalyzerTest {
  ...
  private CacheMetadata createCacheMetadata(int invocationsUsed, String cacheName) {
  ...
  public void analyzeAgentCachePerformance_specificAgent_filtersCorrectly() {
    CacheMetadata cache1 = createCacheMetadata(1, "cache1");
    CacheMetadata cache2 = createCacheMetadata(3, "cache2");
    CacheMetadata cache3 = createCacheMetadata(5, "cache3");
  ...
  public void analyzeAgentCachePerformance_extractsPromptTokens() {
    CacheMetadata cache = createCacheMetadata(1, "cache1");
  ...
  @Test
  public void analyzeAgentCachePerformance_calculatesAvgInvocationsUsed() {
    CacheMetadata cache1 = createCacheMetadata(2, "cache1");
    CacheMetadata cache2 = createCacheMetadata(5, "cache2");
    CacheMetadata cache3 = createCacheMetadata(8, "cache3");
    ...
    // avg = (2 + 5 + 8) / 3 = 5.0
    assertThat((Double) result.get("avg_invocations_used")).isWithin(0.01).of(5.0);
  }
  ...
  public void analyzeAgentCachePerformance_countsCacheRefreshes() {
    CacheMetadata cache1 = createCacheMetadata(2, "cache1");
    CacheMetadata cache2 = createCacheMetadata(5, "cache2");
    CacheMetadata cache3 = createCacheMetadata(8, "cache1"); // Same cache name as cache1
  ...
  @Test
  public void analyzeAgentCachePerformance_calculatesTotalInvocations() {
    CacheMetadata cache1 = createCacheMetadata(2, "cache1");
    CacheMetadata cache2 = createCacheMetadata(5, "cache2");
    CacheMetadata cache3 = createCacheMetadata(8, "cache3");
    ...
    assertThat(result).containsEntry("total_invocations", 15); // 2 + 5 + 8
  }
  ...
  public void analyzeAgentCachePerformance_returnsLatestCache() {
    CacheMetadata cache1 = createCacheMetadata(1, "cache1");
    CacheMetadata cache2 = createCacheMetadata(2, "cache2");
    CacheMetadata cache3 = createCacheMetadata(3, "cache3");
  ...
  public void analyzeAgentCachePerformance_fullAnalysis_allFieldsPresent() {
    CacheMetadata cache = createCacheMetadata(5, "cache1");
    GenerateContentResponseUsageMetadata usage = createUsageMetadata(1000, 800);
    ...
    assertThat(result).containsKey("avg_invocations_used");
    assertThat(result).containsKey("latest_cache");
    assertThat(result).containsKey("cache_refreshes");
    assertThat(result).containsKey("total_invocations");
    ...
    assertThat(result).hasSize(13); // Exactly 13 fields
  }
  ...
  public void analyzeAgentCachePerformance_multipleCacheRefreshes() {
    CacheMetadata cache1a = createCacheMetadata(1, "cache1");
    CacheMetadata cache2 = createCacheMetadata(1, "cache2");
    CacheMetadata cache1b = createCacheMetadata(5, "cache1");
    CacheMetadata cache3 = createCacheMetadata(1, "cache3");

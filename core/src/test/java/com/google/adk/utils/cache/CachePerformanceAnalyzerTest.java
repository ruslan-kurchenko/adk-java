...
public class CachePerformanceAnalyzerTest {
  ...
  public void analyzeAgentCachePerformance_countsCacheRefreshes() {
    ...
    assertThat(result).containsEntry("cache_refreshes", 2);
  }

  @Test
  public void analyzeAgentCachePerformance_singleCache_reportsZeroRefreshes() {
    ...
    events.add(createEventWithUsage("test-agent", cache1b, usage));
    ...
    assertThat(result).containsEntry("cache_refreshes", 0);
  }
  ...
  public void analyzeAgentCachePerformance_multipleCacheRefreshes() {
    ...
    assertThat(result).containsEntry("cache_refreshes", 3);
